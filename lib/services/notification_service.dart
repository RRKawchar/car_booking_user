...
import 'package:user_currentlocation_test/model/notification_model.dart';
import 'package:user_currentlocation_test/screens/message_screen.dart';
 ...
 TokenService tokenService=TokenService();
  ...
  void handleMessage(BuildContext context, RemoteMessage message) {
    NotificationModel notificationModel = NotificationModel(
      ...
      dropUpLocation: message.data['dropUpLocation'] ?? '',
  ...
  Future<String> getDeviceToken() async {
   ...
   // tokenService.storePassengerToken(token.toString());
    return token!;
  }
